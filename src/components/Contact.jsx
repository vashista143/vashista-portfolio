          ...
          <div className="w-full md:w-1/2 text-white space-y-6">
            ...
            <div className="flex gap-4 pt-4">
              <a href="https://www.instagram.com/v_ista143">
                <img src="/instagram-logo-fill-svgrepo-com.svg" className="w-6 h-6 invert" />
              </a>
              <a href="https://www.linkedin.com/in/vashista-dara/">
                <img src="/linkedin-svgrepo-com.svg" className="w-6 h-6 invert" />
              </a>
              <a href="https://github.com/vashista143/">
                <img src="/github-142-svgrepo-com.svg" className="w-6 h-6 invert" />
              </a>
              <a href="https://www.reddit.com/user/v_ista/">
                <img src="/reddit-svgrepo-com.svg" className="w-8 h-8 invert" />
              </a>
            </div>
          </div>
